...
def dashboard():
    ...
    users = User.get_all()
    sent_messages = Message.get_user_sentmessages(data)
    return render_template("dashboard.html", user = user, users = users, messages = messages, sent_messages = sent_messages)
